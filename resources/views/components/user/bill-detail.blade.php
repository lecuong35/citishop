...
<tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100 mobile:hidden">
    ...
    <td>
        <form method="post" enctype="multipart/form-data" action="{{$confirmLink}}">
            @csrf
            <button type="submit" 
            class=" ml-[20px] px-[16px] py-[8px] bg-[#0d6efd] shadow-md rounded-md text-white">
                {{$confirm}}
        ...
        <form method="post" enctype="multipart/form-data" action="./bill/{{$bill['id']}}/delete">
            @csrf
            <button type="submit"
