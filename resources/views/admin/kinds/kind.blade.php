            ...
            <div class="py-2 inline-block w-full">
                <div class="overflow-hidden">
                    <div class="flex items-center justify-between pb-[30px]">
                        ...
                        <!-- <button class=" ml-[20px] px-[16px] py-[8px] bg-[#0d6efd] shadow-md rounded-md text-white"
                        onclick="clickShow('addKind')">
                            Thêm loại hàng
                        </button> -->
                    ...
                    <table class="w-full ml-[30px] mobile:ml-0">
                        ...
                        <tbody class="text-center">
                                ...
                                <tr id="addKind" class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                                    ...
                                    <form action="http://127.0.0.1:8000/admin/kind" 
                                    id="addKind" method="post" enctype="multipart/form-data">
                                        ...
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            ...
                                            name="name" placeholder="Tên loại sản phẩm" required>
                                        </td>
                                        <td>
                            ...
                            @foreach($kind as $kindItem)
                                <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        {{$kindItem['id']}}
                                    </td>
                                    <form action="http://127.0.0.1:8000/admin/kind/{{$kindItem['id']}}" 
                                    id="kind{{$kindItem['id']}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            ...
                                            name="name" value="<?php echo $kindItem->name ?>"
